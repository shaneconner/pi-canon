...
The design and a four-arm multi-session evaluation are written up in *pi-canon: Mutable Canonical Memory over an Immutable Journal, with Recall by Surfacing*, [doi:10.5281/zenodo.21890647](https://doi.org/10.5281/zenodo.21890647). The benchmark is [canon-bench](https://github.com/shaneconner/canon-bench). Interactive versions of every figure, and the full measurement story, are at [shaneconner.com/projects/pi-canon](https://shaneconner.com/projects/pi-canon/); the narrative version is on [Medium](https://medium.com/@shane.conner/my-agents-wiki-was-written-faster-than-it-was-read-and-what-was-read-sold-me-back-debt-i-had-a8085319c68b).
